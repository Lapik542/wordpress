...
function generate_or_update_pages_from_json() {
    ...
    $json_url = 'https://state-haulex.vercel.app/state.json';
    ...
    if (isset($data['states']) && is_array($data['states'])) {
        ...
        foreach ($data['states'] as $state) {
            ...
            $page_content = '<div class="state-page-container">
...
add_action('after_setup_theme', 'generate_or_update_pages_from_json');
